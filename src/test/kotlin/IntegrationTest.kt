...
class IntegrationTest {
    ...
    fun `should return personalized greeting when name is provided`() {
        ...
        assertThat(response.statusCode).isEqualTo(HttpStatus.OK)
        assertThat(response.body).containsPattern("Good (Morning|Afternoon|Evening), Developer!")
    }
    ...
    fun `should return API response with timestamp`() {
        ...
        assertThat(response.body).containsPattern("Good (Morning|Afternoon|Evening), Test!")
